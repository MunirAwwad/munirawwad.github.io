                ...
                if (self.cellsGrid[i][j].possibleValues != null && self.cellsGrid[i][j].possibleValues.length == 2) {
                    ...
                    for (let m=0; m<9; m++) {
                        if (m!=i && self.cellsGrid[m][j].possibleValues != null) {
                            if (JSON.stringify(self.cellsGrid[i][j].possibleValues.sort()) == JSON.stringify(self.cellsGrid[m][j].possibleValues.sort())) {
                                for (let n=0; n<9; n++) {
                    ...
                    for (let m=0; m<9; m++) {
                        if (m!=j && self.cellsGrid[i][m].possibleValues != null) {
                            if (JSON.stringify(self.cellsGrid[i][j].possibleValues.sort()) == JSON.stringify(self.cellsGrid[i][m].possibleValues.sort())) {
                                for (let n=0; n<9; n++) {
                    ...
                    for (let m=boxQuadrants[0]; m<boxQuadrants[1]; m++) {
                        for (let n=boxQuadrants[2]; n<boxQuadrants[3]; n++) {
                            if (!(m==i && n==j) && self.cellsGrid[m][n].possibleValues != null) {
                                if (JSON.stringify(self.cellsGrid[i][j].possibleValues.sort()) == JSON.stringify(self.cellsGrid[m][n].possibleValues.sort())) {
